...
|  <img src="https://github.com/OlyaBorzynska.png" width="50" height="50">  | [Olha Borzynska](https://github.com/OlyaBorzynska)     | **Scrum Master** | **Hero Section:** Розробка блоку "Герой", модерація документації (README), контроль термінів та внутрішня комунікація.                  |
